/*
 * tproxy sample related variables and functions.
 *
...
static hpx_sample_fetch_kw_list_t nst_sample_fetch_keywords = {
    ILH, {
        { "tproxy.cache.hit", nst_sample_fetch_cache_hit, 0, NULL, SMP_T_BOOL, SMP_USE_HRSHP },
        { "tproxy.host",      nst_sample_fetch_host,      0, NULL, SMP_T_STR,  SMP_USE_HRSHP },
        { "tproxy.uri",       nst_sample_fetch_uri,       0, NULL, SMP_T_STR,  SMP_USE_HRSHP },
        { "tproxy.path",      nst_sample_fetch_path,      0, NULL, SMP_T_STR,  SMP_USE_HRSHP },
        { "tproxy.query",     nst_sample_fetch_query,     0, NULL, SMP_T_STR,  SMP_USE_HRSHP },
        { /* END */ },
    }
};
