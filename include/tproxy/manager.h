 ...
 * This file defines everything related to tproxy manager.
 *
 *
 *
...
#ifndef _tproxy_MANAGER_H
#define _tproxy_MANAGER_H

#include <tproxy/common.h>


#define NST_MANAGER_DEFAULT_PURGE_METHOD        "PURGE"
#define NST_MANAGER_DEFAULT_URI                 "/tproxy"
...
#if defined tproxy_USE_PTHREAD || defined USE_PTHREAD_PSHARED
